...
uint8_t channel = 1;
uint8_t pulseFrequency = DW1000.TX_PULSE_FREQ_64MHZ;
uint8_t dataRate = DW1000.TRX_RATE_110KBPS;
uint8_t preambleLength = DW1000.TX_PREAMBLE_LEN_2048;
...
void initializeDirectMode() {
  if (usingRangingLayer) {
    ...
    byte customMode[3] = { DW1000.TRX_RATE_110KBPS, DW1000.TX_PULSE_FREQ_64MHZ, DW1000.TX_PREAMBLE_LEN_2048 };
...
void applyChannelConfiguration() {
  ...
  pulseFrequency = DW1000.TX_PULSE_FREQ_64MHZ;
  dataRate = DW1000.TRX_RATE_110KBPS;
  preambleLength = DW1000.TX_PREAMBLE_LEN_2048;
